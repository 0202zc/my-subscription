...
def process():
    ...
    # mail_send_with_user(content, "微博热搜榜" + local_time, "1115810371@qq.com", ["lzc980202@163.com"])
...
if __name__ == '__main__':
    ...
    try:
        ...
        scheduler.add_job(func=process, trigger='cron', day_of_week='0-6', hour='8,12,20')
        scheduler.start()
    except Exception as e:
        print(e)
        mail_send_with_user(e, "An Exception from 'weibo_spider.py'", "发件人", "收件人")
